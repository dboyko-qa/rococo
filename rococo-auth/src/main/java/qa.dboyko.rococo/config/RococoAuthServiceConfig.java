...
import qa.dboyko.rococo.config.keys.KeyManager;
import qa.dboyko.rococo.service.OidcCookiesLogoutAuthenticationSuccessHandler;
import qa.dboyko.rococo.service.SpecificRequestDumperFilter;
  ...
  public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http,
    ...
    if (environment.acceptsProfiles(Profiles.of("local", "staging"))) {
      http.addFilterBefore(new SpecificRequestDumperFilter(
          ...
          "/login", "/connect/logout", "/oauth2/.*", "/graphql", "/graphiql"
